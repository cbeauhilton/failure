...
combined = background + methods + results + conclusions

# txt for copy-pasta, spot-checking
out_text_file = config.TEXT_DIR / "00_abstract_manuscript.txt"
# rtf for auto-include in Word docs
out_rtf_file = config.TEXT_DIR / "00_abstract_manuscript.rtf"
# tex for awesome
out_file_latex = config.TEX_SECTIONS_DIR / "00_abstract_manuscript.tex"
